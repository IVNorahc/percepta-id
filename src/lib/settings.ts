...
export const DEFAULT_SETTINGS: CompanySettings = {
  ...
  email: null,
  zones: [
    { name: "Zone d'extraction", color: 'orange', isDanger: false },
    { name: 'Zone de traitement', color: 'blue', isDanger: false },
    { name: 'Zone administrative', color: 'green', isDanger: false },
